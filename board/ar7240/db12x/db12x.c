...
void wasp_gpio_config(void)
{
	/* Name: KK Huang
	 * Date: 2011-10-28
	 * Reason: Patch from Atheros to fix WASP packet lose and BB hang issue
	 */
...
*  Date: 2011-030-29 
*  Name: Charles Teng
*  Reason: patch from James
*	   GPIO CTL LNA
*/
 	ar7240_reg_wr(AR7240_GPIO_OUT_FUNCTION0,
         (ar7240_reg_rd(AR7240_GPIO_OUT_FUNCTION0) & 0xffff0000) | 0x2e2f0000);
}
...
/* Name: KK Huang
 * Date: 2011-12-09
 * Reason: Remove this patch because it causes BT test fail
 */
/* Name: KK Huang
 * Date: 2011-11-24
 * Reason: Patch from Atheros to fix Rx sensitivity issue on DIR-615iX (AP123)
 */
//#ifdef CONFIG_AP123
//	val |= (ar7240_reg_rd(XTAL_ADDRESS) & (((1 << 17) - 1) | (1 << 31)) | (1 << 15));
//#else
